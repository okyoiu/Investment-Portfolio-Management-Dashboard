"""
Django settings for fundmental project.
...
TEMPLATE_DIR = os.path.join(BASE_DIR, "fundmental", "templates")
...
WSGI_APPLICATION = 'fundmental.wsgi.application'
